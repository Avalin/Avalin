...
🖥️ **MineDash** 
A fully custom-built Minecraft server management dashboard (C#, Blazor, Docker) supporting multi-console monitoring, live RCON commands, log streaming, timed commands, user management, and a sleek multi-column layout UI. Built in under 24 hours, production-ready, and containerized for easy deployment.
